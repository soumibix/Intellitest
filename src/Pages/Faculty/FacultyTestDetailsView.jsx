        ...
        <div className="flex justify-between items-start m b-6 bg-[#F7F3F9] p-6 rounded-lg">
          ...
          <div className="text-right text-sm text-gray-600">
            <p>
              ...
              Start Time: {formatTime(testData.startTime)} • End Time: {formatTime(testData.endTime)}
            </p>
            {testData.createdBy && (
              <div className="flex items-center justify-end gap-2 mt-4">
                ...
                <div>
                  <p className="font-medium">{testData.createdBy.name}</p>
                  <p className="text-xs">{testData.createdBy.designation}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div>
          ...
          <div className="space-y-6">
            {testData.questions && testData.questions.length > 0 ? (
              ...
              <p className="text-gray-500 text-center py-8">No questions available for this test</p>
            )}
          </div>
        </div>
      </div>
