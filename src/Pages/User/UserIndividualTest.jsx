...
const UserIndividualTest = () => {
    ...
    // Timer state - set to 60 minutes (3600 seconds)
    ...
    // Handle beforeunload event (page close/reload)
    useEffect(() => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex-col justify-between items-center">
                ...
                <div className="mx-auto flex flex-col md:flex-row items-start md:items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 w-full md:w-auto">
                        <button
                            ...
                            className="flex-1 md:flex-none px-4 py-2 text-red-600 text-sm font-medium hover:bg-red-50 rounded border border-red-600"
                        >
                            Exit Test
                        </button>
                        <button className="flex-1 md:flex-none px-4 py-2 bg-purple-600 text-white text-sm font-medium rounded hover:bg-purple-700 flex items-center justify-center gap-2">
                            Submit
            ...
            <div className='px-4 md:px-8 lg:px-12'>
                {/* Hero Section */}
                <div className="text-white px-4 md:px-6 py-6 md:py-8 my-4 mt-8 rounded-2xl"
                    style={{
                        background: "linear-gradient(to right, #6A1B7E, #6A1B7EE5)",
                    }}
                >
                ...
                <div className="bg-[#F7EAFB] rounded-xl border border-[#6A1B7E33]">
                    <div className="mx-auto px-4 md:px-6 py-4">
                        <p className="text-sm text-[#000]">
                            <span className="font-semibold text-[#6A1B7E]">Instructions:</span> Write your answers on paper, number them clearly as per the questions below, and upload a single PDF containing all your answers.
                            Ensure your handwriting is legible and all pages are included in the correct order.
                        </p>
                    </div>
                </div>
                ...
                <div className="mx-auto py-6">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-2">
                            {/* Progress Bar - Fixed on large screens */}
                        ...
                        {/* Right Column - Upload Section (Fixed on large screens, below on mobile) */}
